...
function scrollToGallery() {
  const yOffset = -100; // Offset in px, adjust for header height
  const y =
    gallerySection.getBoundingClientRect().top + window.scrollY + yOffset;
...
// modal image for cultural categories
...
//modal video for cultural categories
...
// Image preview for uploading of images
...
// Handle form submission (simulate backend save)
document.getElementById("uploadForm").addEventListener("submit", function (e) {
  ...
  alert("Your image has been submitted and is awaiting admin approval.");
